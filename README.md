...
В оригинальном ТЗ нет информации о способах представления выражений с единицами измерения в виде "1/выражение"
Т.е. помимо знаков деления, умножения и самих единиц измерения, в запросе допустима еднственная цифра - 1,
И предназначена она для записи вот таких дробных выражений.

# original task readme - https://github.com/gnkoshelev/universal-converter#readme
